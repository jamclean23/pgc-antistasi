...
_items = [
    ...
    "",
    "- Rally Point",
    "      A free Ambulance is available in the garage box buy menu, in the rebel tab.",
    "      This vehicle automatically deploys a Rally Point when stopped.",
    "      Only one Spawn Ambulance allowed at a time.",
    "      You can only travel to the Rally Point from HQ.",
    "",
    "- Capturing",
