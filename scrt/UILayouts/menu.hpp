...
class InitMessage: SimpleMenuBigger {
	...
	class controls {
		...
		{
			idc = 1600;
			text = "To Battle!"; //--- ToDo: Localize;
			x = 0.448438 * safezoneW + safezoneX;
			y = 0.742 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.033 * safezoneH;
			colorText[] = {0.4039,0.8902,0.9059,0.8};
			colorActive[] = {0.4039,0.8902,0.9059,0.8};
			action = "closeDialog 0";
		};
		class list_01: RscListBox
		{
			idc = 1500;
			...
			w = 0.4125 * safezoneW;
			h = 0.473 * safezoneH;
			onLoad = "_this call SCRT_fnc_ui_popInitMessage;";
		};
	};
};
