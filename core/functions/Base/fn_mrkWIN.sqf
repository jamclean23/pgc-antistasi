...
private _distanceFromHQ = _markerPos distance2D _posHQ;
...
if (_distanceFromHQ > distanceFromHqCap) exitWith
{
    ServerInfo_4("Outpost at %1 (%2): Flag capture cancelled due to distance from hq (%3) greater than distanceFromHqCap (%4)", _outpostGridSquare, _markerX, _distanceFromHQ, distanceFromHqCap);
    ["Too far from HQ", format ["Hq is too far to seize! Max distance: %1m. Current distance: %2m", distanceFromHqCap, _distanceFromHQ]] call SCRT_fnc_misc_deniedHint;
};
