...
if (side player isEqualTo teamPlayer) then {
	_index =player createDiarySubject ["PGC", "Discord"];
	player createDiaryRecord ["PGC",["DISCORD","The Professionals Gaming Community<br/>All are welcome! (18+)<br/>Discord.gg/PgcGaming"]];
