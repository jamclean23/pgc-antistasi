...
{ [_rebelVehicleCosts, _x, 20000] call _fnc_setPriceIfValid } forEach FactionGet(reb, "staticMortars");
...
{ [_rebelVehicleCosts, _x, 2500] call _fnc_setPriceIfValid } forEach FactionGet(reb, "vehiclesCivHeli");
