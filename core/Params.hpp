class Params
{
    ...
    class distanceFromHqCap
    {
        title = "Distance from HQ that a player can capture with a flagpole";
        values[] = {1000, 2000, 3000, 5000, 7000, 9000, 12000, 15000, 20000, 25000, 10000000};
        texts[] = {"1k", "2k", "3k", "5k", "7k", "9k", "12k", "15k", "20k", "25k", "N/A"};
        default = 10000000;
    };
    class distanceSPWN
    {
    ...
    {
        title = "Vehicle base price modifier";
        values[] = {25, 50, 100, 200, 300};
        texts[] = {"0.25x", ".5x", "1x", "2x", "3x"};
        default = 100;
    };
    class vehicleDiscount
    {
        title = "Apply trader discount to vehicles?";
        values[] = {1, 2}; // This is stupid, 0 and 1 are translated to true false, cause math errors. Subtracting 1 from value in fn_vehiclePrice.sqf.
        texts[] = {"No", "Yes"};
        default = 2;
    };
